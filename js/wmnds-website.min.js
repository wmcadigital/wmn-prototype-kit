...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/www/wmnds-website.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/wmnds/components/accordion/_accordion.js":
/*!******************************************************!*\
  !*** ./src/wmnds/components/accordion/_accordion.js ***!
  \******************************************************/
...
/***/ "./src/wmnds/patterns/cookies/cookies.js":
/*!***********************************************!*\
  !*** ./src/wmnds/patterns/cookies/cookies.js ***!
  \***********************************************/
/*! exports provided: default */
...
var cookies = function cookies() {
  ...
  var setCookie = function setCookie(cname, cvalue, exdays) {
    ...
    var expires = 'expires=' + d.toUTCString(); // eslint-disable-line prefer-template

    var domain = 'domain=' + window.location.hostname; // eslint-disable-line prefer-template

    document.cookie = cname + '=' + cvalue + ';' + expires + ';' + domain + ';path=/'; // eslint-disable-line prefer-template
  };

  var getCookie = function getCookie(cname) {
    var name = cname + '='; // eslint-disable-line prefer-template
  ...
  document.addEventListener('DOMContentLoaded', cookiesScan); // When Accept all cookies button is triggered
...
/***/ "./src/wmnds/patterns/footer/_footer.js":
/*!**********************************************!*\
  !*** ./src/wmnds/patterns/footer/_footer.js ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/wmnds/patterns/header-v2/_header-v2.js":
/*!****************************************************!*\
  !*** ./src/wmnds/patterns/header-v2/_header-v2.js ***!
  \****************************************************/
/*! exports provided: default */
...
var headerJs = function headerJs() {
  ...
  megaMenus.forEach(function (menu) {
    ...
    var topLevelLinks = menu.querySelectorAll('.wmnds-mega-menu__primary-menu-link'); // handle events within each top level list item
    ...
    topLevelLinks.forEach(function (topLevelLink, topLevelLinkIndex) {
      ...
      var topLevelListItem = topLevelLink.parentNode.tagName === 'LI' ? topLevelLink.parentNode : topLevelLink;
      var subMenuLinks = topLevelListItem.querySelectorAll('.wmnds-mega-menu__sub-menu-link'); // check if level 3 menus are present, if so add modifier class
      ...
      var setMenuActive = function setMenuActive(active, focusLink) {
        if (active !== false) {
          ...
          topLevelListItem.classList.remove('active'); // set focus on menu close
        ...
        if (key === 13 || key === 32 || key === 40) {
          ...
          var openSubMenu = function openSubMenu() {
            if (topLevelListItem.querySelectorAll('.wmnds-mega-menu__container').length) {
              ...
              setMenuActive(true); // focus first menu item
      ...
      topLevelLink.addEventListener('mousedown', function (e) {
        ...
        e.preventDefault(); // setMenuActive(false);
      }); // topLevelLink.addEventListener('focus', handleKeyFocus);

      var menuArray = [];
      subMenuLinks.forEach(function (menuLink, menuIndex) {
        var thisList = menuLink.parentNode;
        var thisListLinks = thisList.querySelectorAll('a'); // push list of links to array

        menuArray.push(thisListLinks);
        thisListLinks.forEach(function (link, linkIndex) {
          link.addEventListener('keydown', function (e) {
            if (e.keyCode !== 27) {
              ...
              if (e.keyCode === 39) {
                ...
                e.preventDefault();
                var nextMenuLink = getMenuLink(linkIndex, menuArray[menuIndex + 1]);
                if (nextMenuLink) nextMenuLink.focus();
              } else if (e.keyCode === 37) {
                // left arrow - go to link of same index in previous menu list
                e.preventDefault();
                var prevMenuLink = getMenuLink(linkIndex, menuArray[menuIndex - 1]);
                ...
                var nextLink = getMenuLink(linkIndex, thisListLinks, 'next') ? getMenuLink(linkIndex, thisListLinks, 'next') : getMenuLink(-1, menuArray[menuIndex + 1], 'next');
                ...
                e.preventDefault();
                var prevMenu = menuArray[menuIndex - 1];
                var prevLink = null;

                if (prevMenu || linkIndex > 0) {
                  prevLink = getMenuLink(linkIndex, thisListLinks, 'prev') ? getMenuLink(linkIndex, thisListLinks, 'prev') : getMenuLink(prevMenu.length, prevMenu, 'prev');
                }
...
/*!*******************************************************************!*\
  !*** ./src/www/_partials/component-example/_component-example.js ***!
  \*******************************************************************/
/*! exports provided: showCode, displayShowMore, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showCode", function() { return showCode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "displayShowMore", function() { return displayShowMore; });
...
var displayShowMore = function displayShowMore(element) {
  ...
  if (element.clientHeight >= 192 && !element.classList.contains('wmnds-show-more-ignore')) {
    var htmlString = '<a href="#" class="wmnds-link wmnds-js-show-code">Show more code</a>';
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  document.querySelectorAll('.wmnds-js-show-code').forEach(function (ele) {
...
function aToZContentStyleGuide() {
  ...
  var changeAccordionState = function changeAccordionState(accordionElem) {
    ...
    var accordionBtn = accordionElem.querySelector('.wmnds-accordion__summary-wrapper');
  ...
  var changeAllAccordionStates = function changeAllAccordionStates(changeStateToOpen) {
    var accordions = document.querySelectorAll('main .wmnds-accordion');
    accordions.forEach(function (accordion) {
...
function colorPalettes() {
  var colors = document.querySelectorAll('.wmnds-website-color-swatch__inner'); // Function to convert rgb to hex
...
/* harmony import */ var _assets_vendor_js_polyfills_ie11_forEach__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/vendor/js/polyfills/ie11-forEach */ "./src/www/assets/vendor/js/polyfills/ie11-forEach.js");
...
/* harmony import */ var _partials_component_example_component_example__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_partials/component-example/_component-example */ "./src/www/_partials/component-example/_component-example.js");
/* harmony import */ var _wmnds_patterns_cookies_cookies__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../wmnds/patterns/cookies/cookies */ "./src/wmnds/patterns/cookies/cookies.js");
/* harmony import */ var _wmnds_patterns_header_v2_header_v2__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../wmnds/patterns/header-v2/_header-v2 */ "./src/wmnds/patterns/header-v2/_header-v2.js");
/* harmony import */ var _wmnds_patterns_footer_footer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../wmnds/patterns/footer/_footer */ "./src/wmnds/patterns/footer/_footer.js");
/* harmony import */ var _wmnds_components_accordion_accordion__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../wmnds/components/accordion/_accordion */ "./src/wmnds/components/accordion/_accordion.js");
...
window.addEventListener('DOMContentLoaded', (_assets_vendor_js_polyfills_ie11_forEach__WEBPACK_IMPORTED_MODULE_1__["default"], icons(), Object(_pages_styles_a_to_z_content_style_guide_a_to_z_content_style_guide__WEBPACK_IMPORTED_MODULE_3__["default"])(), Object(_pages_styles_colour_palettes_color_palettes__WEBPACK_IMPORTED_MODULE_2__["default"])(), Object(_wmnds_patterns_header_v2_header_v2__WEBPACK_IMPORTED_MODULE_6__["default"])(), Object(_wmnds_patterns_footer_footer__WEBPACK_IMPORTED_MODULE_7__["default"])(), Object(_wmnds_components_accordion_accordion__WEBPACK_IMPORTED_MODULE_8__["default"])(), Object(_wmnds_patterns_cookies_cookies__WEBPACK_IMPORTED_MODULE_5__["default"])(), _partials_component_example_component_example__WEBPACK_IMPORTED_MODULE_4__["default"]));

/***/ })

/******/ });
//# sourceMappingURL=wmnds-website.min.js.map